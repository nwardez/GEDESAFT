...
//	@Override
//	public List<VehiculeModel> listData() throws Exception {
//		VehiculeModel vehicule;
//		PreparedStatement pstmt = null;
//		ResultSet rs;
//		String sql;
//		List<VehiculeModel> aListOfVehicule = new ArrayList<VehiculeModel>();
//
//		try {
...
//		}
//
//		return aListOfVehicule;
//	}
	
//	private VehiculeModel getVehiculeFromResultSet(ResultSet rs) throws Exception {
//		VehiculeModel vehicule = new VehiculeModel();
//		String requestAffaire = "SELECT DISTINCT nomAffaire FROM affaire JOIN affaire_has_vehicule ON affaire.id_affaire = affaire_has_vehicule.id_affaire WHERE id_vehicule = ?";
//		String requestADN = "SELECT DISTINCT nomADN FROM adn JOIN vehicule_has_adn ON adn.id_ADN = vehicule_has_adn.id_adn WHERE id_vehicule = ?";
//		String requestEmpreinte = "SELECT DISTINCT nomEmpreintes FROM empreintes JOIN vehicule_has_empreintes ON empreintes.id_empreintes = vehicule_has_empreintes.id_empreintes WHERE id_vehicule = ?";
//		String requestProtagonniste = "SELECT DISTINCT nomProtagonniste FROM protagonniste JOIN vehicule ON protagonniste.id_protagonniste = vehicule.id_protagonniste WHERE id_vehicule = ?";
//		Long id = rs.getLong("id_vehicule");
